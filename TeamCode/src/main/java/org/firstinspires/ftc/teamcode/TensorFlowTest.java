...
public class TensorFlowTest extends LinearOpMode {
    ...
    public void initialize() {
        //find TFOD_MODEL_ASSET string
        VuforialLocalizer.Parameters parameters = new VuforialLocalizer.Parameters();
        ...
        TFObjectDetector.Parameters tfodParameters = new TFObjectDetector.Parameters(tfoodMonitorViewId);
